...
- 2026-08-23（最终远端复核）：`origin/codex/v1-integration` 当前为 `2d74fde89999dfe63bbc7f934a0862f1497cb5c`，`origin/0.1.1` 当前为 `744683fef78b6ac2ddaa8f80c585012e3dd20550`，merge-base 为 `d8a4367adc1e322351126e8ab3676d30584475d5`；旧的 `d8a4367` 候选头叙述已降级为历史事实。`Resolution: open`、未配置保护规则和未验证边界均保持不变。

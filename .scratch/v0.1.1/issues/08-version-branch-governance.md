...
- 2026-08-23（最终代码验证基线）：版本治理核对绑定的集成代码基线为 `f2748c93a7da18607f4f35bd2d70896630f551f7`，`origin/0.1.1` 为 `744683fef78b6ac2ddaa8f80c585012e3dd20550`，merge-base 为 `d8a4367adc1e322351126e8ab3676d30584475d5`。本记录随后通过普通文档合并进入 integration；`Resolution: open`、未配置保护规则和未验证边界均保持不变。
...
- 2026-08-23 07:20:51 +08:00（版本分支合并后复核）：远端裸版本分支 `0.1.1` 已推进到 `7478fa364fea4fc2b4ae5336b1d92e3904b68f5b`，其父链包含集成头 `d8a4367adc1e322351126e8ab3676d30584475d5`；远端未发现 `v0.1.1`、`codex/v0.1.1` 或其他同版本长期别名。保护 API 仍返回 404（未保护），未创建 tag/Release、未合入 `main`、未接受 WiX 条款；`Resolution: open` 保持不变。
- 2026-08-23（当前远端事实）：远端 `codex/v1-integration`=`1224b865114ec47b2708fc859eae73d483d2ac6e`，远端 `0.1.1`=`744683fef78b6ac2ddaa8f80c585012e3dd20550`；merge-base=`d8a4367adc1e322351126e8ab3676d30584475d5`。`git rev-list --left-right --count origin/0.1.1...origin/codex/v1-integration` 为 `2/8`（2 behind、8 ahead）。本次版本分支核对仅保留裸长期分支 `0.1.1`，未创建 `v0.1.1`、`codex/v0.1.1` 或其他同版本别名；保护 API 返回 HTTP 404（`Branch not protected`），不能写成已保护。未创建 tag/Release、未合入 `main`、未接受 WiX 条款。`Resolution: open` 保持不变；PR/CI 放行、ARM64、DPI、安装生命周期和实机 UI/无障碍仍未验证。

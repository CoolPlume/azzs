...
- [ ] `release/artifact-content-manifest.v1.json` 覆盖八制品对应的目录资源布局和架构变体；`package manifest` 记录规范化仓库相对包路径及其内容绑定，不含 `__FILE__` 派生的绝对路径、盘符或开发机路径。
...
`CONTEXT.md` 中的“便携版”“自包含发行包”“标准版”“断网救援版”“超大离线版”“候选资源”、事项 03、19、20、21、25、29、`docs/adr/0030-controlled-rescue-tool-release-boundary.md`、`docs/adr/0037-three-edition-eight-artifact-matrix.md`、`docs/engineering/architecture-and-code-quality.md`。

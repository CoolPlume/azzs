...
struct GuidedInitializationPresentationText final {
  ...
  std::string read_only_disabled_reason{"flow state is read-only"};
  std::string stage_empty_body{"No flow has recorded this stage yet."};
  std::string raw_detail_prefix{"Raw system information: "};
  std::string raw_error_prefix{"Raw error information: "};
  std::string drivers_stage_title{"Drivers"};
  std::string system_optimization_stage_title{"System optimization"};
  std::string software_installation_stage_title{"Software installation"};
  std::string software_optimization_stage_title{"Software optimization"};
  std::string unknown_stage_title{"Unknown stage"};
  std::string stage_pending_body{"Pending"};
  std::string stage_active_body{"In progress"};
  std::string stage_completed_body{"Completed"};
  std::string stage_skipped_body{"Skipped"};
  std::string stage_no_applicable_body{"No applicable items"};
  std::string stage_partial_body{"Partial"};
  std::string stage_failed_body{"Failed"};
  std::string stage_confirmation_body{"Awaiting confirmation"};
  std::string stage_waiting_explorer_body{"Waiting for Explorer restart"};
  std::string stage_waiting_restart_body{"Waiting for Windows restart"};
  std::string stage_withdrawn_body{"Emergency withdrawn"};
  std::string stage_external_handoff_body{"Awaiting external installation handoff"};
  std::string stage_not_executed_body{"Not executed"};
};
